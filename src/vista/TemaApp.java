...
public class TemaApp {
    ...
    public static TemaApp obtenerTema(String nombre) {
        ...
        switch (nombre) {
            ...
            case "Cyberpunk":
                return tema("Cyberpunk",c(12,8,28), c(25,12,55), c(8,6,22), c(245,245,255), c(0,255,255), c(120,0,255), c(255,0,180), c(18,8,38), c(245,245,255), c(255,230,0), c(255,0,180), c(0,255,255));
            default:
